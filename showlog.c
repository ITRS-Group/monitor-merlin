...
static struct string_code event_codes[] = {
	...
	add_event("HOST NOTIFICATION", EVT_NOTIFY | EVT_SERVICE),
	add_event("HOST FLAPPING ALERT", EVT_FLAPPING | EVT_HOST),
	add_event("SERVICE NOTIFICATION", EVT_NOTIFY | EVT_SERVICE),
	add_event("SERVICE FLAPPING ALERT", EVT_FLAPPING | EVT_SERVICE),
	add_event("LOG ROTATION", EVT_LROTATE),
	add_event("HOST EVENT HANDLER", EVT_EHANDLER | EVT_HOST),
