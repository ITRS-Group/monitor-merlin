...
INSERT INTO report_data_extras_tmp (`timestamp`, `event_type`, `flags`, `attrib`, `host_name`, `service_description`, `state`, `hard`, `retry`, `downtime_depth`, `output`)
SELECT `timestamp`, `event_type`, `flags`, `attrib`, `host_name`, `service_description`, `state`, `hard`, `retry`, `downtime_depth`, `output`
FROM report_data_extras;

ALTER TABLE report_data_extras RENAME report_data_extras_old;
ALTER TABLE report_data_extras_tmp RENAME report_data_extras;
DROP TABLE report_data_extras_old;
