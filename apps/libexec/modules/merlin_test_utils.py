...
define host{
    name                           mtest-default-host-template
    max_check_attempts             2
    check_interval                 1
    retry_interval                 1
    active_checks_enabled          1
    passive_checks_enabled         1
    check_period                   mtest-24x7
    ...
    notification_period            mtest-24x7
...
define service{
    name                           mtest-default-service-template
    is_volatile                    0
...
define contact{
    use                            mtest-default-contact-template
